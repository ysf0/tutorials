...
(source-id: 263) dosyası aşağıdaki gibidir:
 ...
 * -ENOSYS if users try to call a syscall that doesnt exist.  To keep
...
Yukarıdaki dosyada import edilen header'ın içeriği ise şuradadır: (source-id: 264)
...
(source-id: 265) dosyası aşağıdaki gibidir:
